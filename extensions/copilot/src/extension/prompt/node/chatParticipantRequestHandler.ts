...
import { Conversation, getGlobalContextCacheKey, GlobalContextMessageMetadata, ICopilotChatResult, ICopilotChatResultIn, ModelTokenUsageMetadata, normalizeSummariesOnRounds, RenderedUserMessageMetadata, Turn, TurnStatus } from '../common/conversation';
...
function createTurnFromVSCodeChatHistoryTurns(
	...
	if (turnMetadata?.promptTokens && turnMetadata?.outputTokens) {
		currentTurn.setMetadata(new ModelTokenUsageMetadata(turnMetadata.promptTokens, turnMetadata.outputTokens));
	}
